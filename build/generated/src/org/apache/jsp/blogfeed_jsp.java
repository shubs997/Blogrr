...
public final class blogfeed_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	if(session.getAttribute("username")==null)
	{
      ...
      out.write("\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t<p>Publish your passions your way. Whether you'd like to share your knowledge, experiences or the latest news, create a unique and beautiful blog for free.</p>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<!--/ End About -->\n");
      out.write("\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<h4><a href=\"blog-single.html\">Help center</a></h4>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"single-news\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<h4><a href=\"blog-single.html\">Help Forum</a></h4>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"single-news\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<h4><a href=\"blog-single.html\">Video tutorials</a></h4>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("</p>\n");
          out.write("                                                                                        <div class=\"button\">\n");
          out.write("                                                                                                <!-- pass unique blog-title in url to display blog-body of that blog-->\n");
          out.write("                                                                                                <a href=\"readMoreServlet?blogTitle=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${s.title}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\" class=\"btn\">Read More<i class=\"fa fa-angle-double-right\"></i></a>\n");
          out.write("                                                                                        </div>\n");
          out.write("                                                                                </div>\n");
          out.write("                                                                        </div>\n");
          out.write("                                                                        <!-- End Single Blog -->\n");
